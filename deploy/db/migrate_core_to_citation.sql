...
TRUNCATE TABLE public.citation_publication_model_documentation
    RESTART IDENTITY
    CASCADE;
TRUNCATE TABLE public.citation_publication_platforms
    RESTART IDENTITY
    CASCADE;
TRUNCATE TABLE public.citation_publication_sponsors
    RESTART IDENTITY
    CASCADE;
TRUNCATE TABLE public.citation_publication_tags
    RESTART IDENTITY
    CASCADE;
...
insert into citation_modeldocumentation (id, name)
  select id, name
  from core_modeldocumentation;


insert into citation_platform (id, name, url, description)
  select id, name, '', ''
  from core_platform;


insert into citation_sponsor (id, name, url, description)
  select id, name, '', ''
  from core_sponsor;


insert into citation_tag (id, name)
  select id, name
  from core_tag;
...
insert into citation_publication_platforms
  select *
  from core_publication_platforms;

insert into citation_publication_sponsors
  select *
  from core_publication_sponsors;

insert into citation_publication_tags
  select *
