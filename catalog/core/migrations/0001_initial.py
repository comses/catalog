# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-06-09 20:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('series_text', models.CharField(blank=True, max_length=255)),
        ...
        migrations.AddField(
            ...
            name='publication',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='audit_log_set', to='core.Publication'),
        ),
        migrations.AddField(
            model_name='publication',
            name='added_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='added_publication_set', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='publication',
            name='assigned_curator',
            field=models.ForeignKey(blank=True, help_text='Currently assigned curator', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='assigned_publication_set', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='publication',
            name='creators',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, to='core.ModelDocumentation'),
        ),
        migrations.AddField(
            model_name='publication',
            name='platforms',
            field=models.ManyToManyField(blank=True, to='core.Platform'),
        ),
        migrations.AddField(
            model_name='publication',
            name='sponsors',
